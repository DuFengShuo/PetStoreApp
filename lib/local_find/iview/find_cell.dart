...
class LocalFindCellWidget extends StatefulWidget {
  @override
  _LocalFindCellWidgetState createState() => _LocalFindCellWidgetState();
}

class _LocalFindCellWidgetState extends State<LocalFindCellWidget> {
  @override
