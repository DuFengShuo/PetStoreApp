...
class LocalFindPage extends StatefulWidget {
  LocalFindPage({Key key}) : super(key: key);

  @override
  _LocalFindPageState createState() => _LocalFindPageState();
}

class _LocalFindPageState extends State<LocalFindPage>
    with
        AutomaticKeepAliveClientMixin<LocalFindPage>,
        BasePageMixin<LocalFindPage, PowerPresenter>
