...
class PhoneOneKeyLoginPage extends StatefulWidget {
  @override
  _PhoneOneKeyLoginPageState createState() => _PhoneOneKeyLoginPageState();
}

class _PhoneOneKeyLoginPageState extends State<PhoneOneKeyLoginPage>
    with
        ChangeNotifierMixin<PhoneOneKeyLoginPage>,
        BasePageMixin<PhoneOneKeyLoginPage, PowerPresenter>
  ...
  List<Widget> _buildBody() {
    return <Widget>[
      ...
      Column(
        children: [
          Text("18801114228",style: TextStyles.textBold24.copyWith(color: Colours.text),),
          Gaps.vGap10,
          Text("认证服务由某某某提供",style: TextStyles.textSize10.copyWith(color: Colours.text_gray_holder),),
          Gaps.vGap40,
          MyButton(
