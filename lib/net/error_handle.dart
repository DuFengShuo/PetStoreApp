...
class ExceptionHandle {
  ...
  static final Map<int, NetError> _errorMap = <int, NetError>{
    ...
    //
    net_error:
        NetError(net_error, 'Network abnormal, please check your network！'),
    parse_error: NetError(parse_error, 'Data parsing error!'),
    socket_error:
        NetError(socket_error, 'Network abnormal, please check your network!'),
    http_error:
        NetError(http_error, 'Server abnormal, please try again later！'),
    ...
    receive_timeout_error:
        NetError(receive_timeout_error, 'Response timed out!'),
