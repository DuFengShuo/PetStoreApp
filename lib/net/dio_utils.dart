...
//    };
  ...
  Future requestNetwork<T>(
    ...
    return _request<T>(
      ...
      data: Constant.acceptDebug
          ? (isUpdateImage ? params : JhEncryptUtils.aesMd5Base64(params))
          : params,
      queryParameters: queryParameters,
      options: options,
      cancelToken: cancelToken,
      ...
      if (result.code == 0) {
        ...
        // GlobalEventBus().event.fire(ErrEventBus(result.code));
  ...
  void asyncRequestNetwork<T>(
    ...
    Stream.fromFuture(_request<T>(
      method.value,
      url,
      data: Constant.acceptDebug ? JhEncryptUtils.aesMd5Base64(params) : params,
      queryParameters: queryParameters,
      options: options,
      cancelToken: cancelToken,
  ...
  void _cancelLogPrint(dynamic e, String url) {
    if (e is DioError && CancelToken.isCancel(e)) {
      // Log.e('取消请求接口： $url');
      Log.e('Cancel the request interface: $url');
    }
  }
