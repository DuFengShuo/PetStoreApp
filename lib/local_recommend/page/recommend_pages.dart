...
class RecommendsPage extends StatefulWidget {
  RecommendsPage({Key key}) : super(key: key);
...
class _RecommendsPageState extends State<RecommendsPage>
    with
        AutomaticKeepAliveClientMixin<RecommendsPage>,
        BasePageMixin<RecommendsPage, PowerPresenter>
    implements RecommendIview {
  @override
  BaseListProvider<dynamic> companyListProvider =
  BaseListProvider<dynamic>();

  RecommendPresenter _recommendPresenter;

  @override
  PowerPresenter createPresenter() {
    final PowerPresenter powerPresenter = PowerPresenter<dynamic>(this);
    _recommendPresenter = RecommendPresenter();
