...
class DiscountCellWidget extends StatefulWidget {
  @override
  _DiscountCellWidgetState createState() => _DiscountCellWidgetState();
}

class _DiscountCellWidgetState extends State<DiscountCellWidget> {
  @override
