...
import 'package:local_life_app/scroll_views/left_scroll_page.dart';
...
class _ScrollListPageState extends State<ScrollListPage> {
  List datas = ["头部停靠","渐变导航栏","头部底部联动","头部自定义底部联动", "pageview联动", "左右联动", "每栏头部悬浮","折叠table","拉拽效果"];
  List<Widget> allWidget = [HeaderStopPage(),SliverAppBarPage(),ScrollablePositionedListPage(),ScrollableTabView(),PageTabView(),SpLiftListPage(), HeaderStopPage(),HeaderStopPage()];
  @override
