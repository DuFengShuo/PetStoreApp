...
class OldGoodsCellWidget extends StatefulWidget {
  @override
  _OldGoodsCellWidgetState createState() => _OldGoodsCellWidgetState();
}

class _OldGoodsCellWidgetState extends State<OldGoodsCellWidget> {
  @override
